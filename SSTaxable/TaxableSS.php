...
<body>
	<div class="tool-container">
		...
		<div class="table-3x" id="LivedWithSpouseContainer">
			<p>Lived with Spouse</p>
			<input class="trigger checkbox" type="checkbox" id="LivedWithSpouse"
				tooltipid="#LivedWithSpouseTT" />
			<p>&nbsp;</p>
		</div>
		<div class="table-3x">
		   	<p>Social Security</p>
