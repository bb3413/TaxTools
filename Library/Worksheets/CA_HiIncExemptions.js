...
export class CA_HiIncExemptions extends TaxForm {
	...
	calculate() {
		...
		this.lines["0f"].value	= (TaxFormObj.getValue("F540", "07") +		// Number of Personal Exemptions
									TaxFormObj.getValue("F540", "08") +
									TaxFormObj.getValue("F540", "09")) / personal_exemption;
		this.lines["0g"].value	= this.line("0e") * this.line("0f");
		this.lines["0h"].value	= TaxFormObj.getValue("F540", "07") +		// Amount of Personal Exemptions
									TaxFormObj.getValue("F540", "08") +
									TaxFormObj.getValue("F540", "09");
		this.lines["0i"].value	= Math.max(0, this.subtract("0h", "0g"));
		this.lines["0j"].value	= TaxFormObj.getValue("F540", "10") / dependent_exemption; // Number of Personal Exemptions
		this.lines["0k"].value	= this.line("0e") * this.line("0j");
		this.lines["0l"].value	= TaxFormObj.getValue("F540", "10"); 		// Amount of Personal Exemptions
