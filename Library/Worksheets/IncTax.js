...
export class IncTax extends Form {
	...
	calculate() {
		...
		this.lines["01"].value	= Forms.getValue("F1040",	"15");		// Taxable Income
		this.lines["02"].value	= Forms.getValue("F1040",	"03a");		// Qualified Dividends
		this.lines["03"].value	= Forms.getValue("F1040",	"07");		// Capital Gains
