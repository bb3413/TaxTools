...
export class F1040SSE extends Form {
	...
	calculate() {
		...
		this.lines["02"].value		= Forms.getValue("F1040SC", "31");	// Net profit from business
		...
		this.lines["08a"].value		= Forms.getValue("W2", "03") +
										Forms.getValue("W2", "07");	// Boxes 3 and 7 on W-2
