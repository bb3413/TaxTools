...
import { get_CapGains_15_Start, get_CapGains_20_Start }	from "../TaxTables/TaxTables.js";
import { getIncomeTaxFromTable }						from "../TaxTables/TaxTables.js";
...
function getIncomeTax(
	...
	tx_line_5	= max(0, tx_line_1 - tx_line_4);		// Total ordinary income
	...
	tx_line_9	= max(0, tx_line_7 - tx_line_8);		// Amount taxed at 0%
	tx_line_10	= min(tx_line_1, tx_line_4);
	tx_line_11	= tx_line_9;
	tx_line_12	= max(0, tx_line_10 - tx_line_11);
