...
export class F1040S2 extends Form {
	...
	calculate() {
		...
		this.lines["02"].value	= Forms.getValue("F6251", "11");	// AMT
		this.lines["03"].value	= this.add("01z", "02");			// Total Extra Tax

		// Other Taxes
		this.lines["04"].value	= Forms.getValue("F1040SSE", "12");	// Self-employment Tax
		...
		this.lines["11"].value	= Forms.getValue("F8959", "18");	// Additional Medicare Tax
		this.lines["12"].value	= Forms.getValue("F8960", "17");	// Investment Income Tax
		...
		this.lines["17c"].value	= Forms.getValue("F8889", "17b");	// Additional Tax on HSA Distributions
		this.lines["17d"].value	= Forms.getValue("F8889", "21");	// Additional Tax on HSA
		...
		this.lines["17p"].value	= Forms.getValue("F8621", "16f");	// Interest from Form 8621, line 16f
		this.lines["17q"].value	= Forms.getValue("F8621", "24");	// Interest from Form 8621, line 24
