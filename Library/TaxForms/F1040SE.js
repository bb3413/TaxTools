...
export class F1040SE extends TaxForm {
	constructor(formname) {
		Debug.enter("F1040SE.Constructor()");
		super(formname);
		...
		Debug.exit("F1040SE.Constructor()");
	}
