...
export class F1040SB extends TaxForm {
	constructor(formname) {
		Debug.enter("F1040SB.Constructor()");
		super(formname);
		...
		Debug.exit("F1040SB.Constructor()");
	}
