...
export class F1099LTC extends TaxForm {
	constructor(formname) {
		Debug.enter("F1099LTC.Constructor()");
		super(formname);
		...
		Debug.exit("F1099LTC.Constructor()");
	}
	...
	calculate() {
		...
		Debug.enter("F1099LTC.calculate()");
